...
module.exports = {
    ...
    DS_FILENAME: 'datastore.json',
    DS_CRYPT_KEY_SEED: process.env.DS_CRYPT_KEY_SEED || 'For further information on how we use your information, if you wish to contact us or raise a complaint, please see our privacy policy'
};